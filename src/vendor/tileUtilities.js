    ...
    tiledMap.layers.forEach((tiledLayer) => {
      ...
      if (tiledLayer.type === 'tilelayer') {
        ...
        tiledLayer.data.forEach((gid, index) => {
          let tileSprite; let texture; let mapX; let mapY; let tilesetX; let tilesetY;


          let mapColumn; let mapRow; let tilesetColumn; let
            tilesetRow;
